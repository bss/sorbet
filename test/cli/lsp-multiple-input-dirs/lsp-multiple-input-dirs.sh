...
WORKSPACE_DIR="$PWD/test/cli/lsp-multiple-input-dirs/dir_b"

main/sorbet --silence-dev-message --lsp --disable-watchman --dir test/cli/lsp-multiple-input-dirs/dir_a --dir test/cli/lsp-multiple-input-dirs/dir_b < "$in_pipe" &
sorbet_pid=$!
